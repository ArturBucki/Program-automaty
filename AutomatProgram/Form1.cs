        ...
        private void Check_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                if (a == true && b == false && c == false)
                {
                    ...
                    if(characters[i] == '1')
                    {
                        pictureBox3.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\LoppedRed.png");
                        pictureBox2.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\Lopped2.png");
                        pictureBox1.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\curved arrow2.png");
                        a = true;
                        b = false;
                        c = false;
                    }
                    ...
                    {
                        pictureBox3.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\Lopped2.png");
                        pictureBox2.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\Lopped2.png");
                        pictureBox1.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\curved arrow2.png");
                        a = false;
                        b = true;
                ...
                if (b == true && a == false && c == false)
                {
                    ...
                    if (characters[i] == '1')
                    {
                        pictureBox1.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\curvedArrowPic1Red.png");
                        a = true;
                        b = false;
                        c = false;
                    }
                ...
                if (c == true && b == false && a == false)
                {
                    ...
                    if (characters[i] == '1')
                    {
                        pictureBox2.Image = Image.FromFile(@"C:\Users\Artur\Desktop\Semestr 5\Elementy jeezykow\Automat program\AutomatProgram\LoppedRed.png");
                        a = false;
                        b = false;
                        c = true;
                    }
